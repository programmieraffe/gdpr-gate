...
<body>
    ...
    <div id="container">
        ...
        <p><?php _e("This website is built with Wordpress, an open source software for blogs and multimedia content. This website relies heavily on external content and contains embeds from third party providers, such as YouTube videos, Twitter postings, Instagram photos, external images and more - or external webdevelopment resources such as Google Fonts or software provided by so called CDNs. All of this content will be loaded from third party providers, which may track you - details can be found in the privacy policies of the companies offering these services. If you do not agree to these embeds, please DO NOT use this website. Advice: You can use tools such as Privacy Badger by EFF to control your privacy online. Thank you very much!", $plugin_namespace)?></p>



<?php if(isset($privacy_policy_content)){ ?>
    <p><?php _e('Privacy policy text of this website:', $plugin_namespace)?></p>
    <div class="text-content-window"><?php echo $privacy_policy_content; ?>
    </div>
<?php } /* eif pcontent */ ?>

<p class="consent-box"><i><button id="confirm"><?php _e('I agree to this privacy policy', $plugin_namespace)?></button><br><br> <?php _e('By agreeing to this privacy policy there will be an cookie stored on your computer which documents your confirmation for 15 minutes. To revoke your confirmation earlier, please delete your cookies in your browser. You will be redirected to the page content after clicking agree.', $plugin_namespace)?></i></p>
